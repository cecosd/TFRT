...
function your_prefix_get_meta_box( $meta_boxes ) {
    ...
    $meta_boxes[] = array(
        'id' => 'movies',
        'title' => esc_html__( 'movie', 'meta_box' ),
        ...
        'fields' => array(
            array(
                'id' => $prefix . 'year',
                'type' => 'number',
                'name' => esc_html__( 'Year of release', 'meta_box' ),
            ),
            array(
                'id' => $prefix . 'director',
                'type' => 'text',
                'name' => esc_html__( 'Director', 'meta_box' ),
            ),
            array(
                'id' => $prefix . 'imdb',
                'type' => 'number',
                'name' => esc_html__( 'IMDB Rating', 'meta_box' ),
            ),
            array(
                'id' => $prefix . 'description',
                'type' => 'textarea',
                'name' => esc_html__( 'Description', 'meta_box' ),
            ),
        ),
    );
